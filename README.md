...
### Desenvolvedor Front-End | Estudante de ADS | Apaixonado por UI/UX

Sou um desenvolvedor focado no ecossistema Front-End, unindo minha experiência prévia com Design para criar interfaces não apenas funcionais, mas visualmente refinadas e intuitivas. Atualmente, estudo Análise e Desenvolvimento de Sistemas (ADS) no IFSP e meu ambiente de desenvolvimento roda no Zorin OS, o que me dá total controle para otimizar meu fluxo de trabalho.
